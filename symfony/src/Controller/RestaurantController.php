...
class RestaurantController extends AbstractController
{
    ...
    public function newProduct(Request $request, Restaurant $restaurant, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->renderForm('restaurant/new-product.html.twig', [
            'restaurant' => $restaurant,
            'form' => $form,
            'product' => $product,
        ]);
     ...
     */
    public function deleteProduct(Request $request, Product $product, PurchaseOrderLineRepository $purchaseOrderLineRepository, EntityManagerInterface $entityManager): Response
    {
        $restaurant = $product->getRestaurant();
